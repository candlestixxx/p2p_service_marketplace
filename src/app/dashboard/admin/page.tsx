...
import { Users, LayoutList, DollarSign, Wallet, Star, Info } from "lucide-react";
              ...
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium flex items-center gap-2">
                   ...
                   <Tooltip>
                      ...
                      <TooltipContent>Gross Merchandise Value. The total value of all confirmed transactions processed through the marketplace.</TooltipContent>
                   </Tooltip>
                </CardTitle>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium flex items-center gap-2">
                   ...
                   <Tooltip>
                      <TooltipTrigger><Info className="h-3 w-3 text-muted-foreground" /></TooltipTrigger>
                      <TooltipContent>The net revenue retained by the platform (calculated via Stripe Destination Charges).</TooltipContent>
                   </Tooltip>
                </CardTitle>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium flex items-center gap-2">
                   ...
                   <Tooltip>
                      <TooltipTrigger><Info className="h-3 w-3 text-muted-foreground" /></TooltipTrigger>
                      <TooltipContent>The sum of all registered clients, providers, and administrators across the platform.</TooltipContent>
                   </Tooltip>
                </CardTitle>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium flex items-center gap-2">
                   ...
                   <Tooltip>
                      <TooltipTrigger><Info className="h-3 w-3 text-muted-foreground" /></TooltipTrigger>
                      <TooltipContent>The total number of marketplace listings currently available to be booked.</TooltipContent>
                   </Tooltip>
                </CardTitle>
